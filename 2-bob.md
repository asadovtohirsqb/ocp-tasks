...
## 12. What is the result of executing the following code snippet? (Choose all that apply.)
```java
int start = 7;
int end = 4;
end += ++start;
...
## 13. Which of the following statements about unary operators are true? (Choose all that apply.)  
