...
```
The correct answer is in `class/packagea/ClassA.class`. The package structure is preserved under the requested target directory. `Figure 1.2` shows this new structure.
